...
**/
;(function(o,f,t){var k=soundManager,g=null,i=null,h=[],a={},n,p=-1;if("Microsoft Internet Explorer"==navigator.appName){var q=navigator.userAgent,r=/MSIE ([0-9]{1,}[.0-9]{0,})/;null!=r.exec(q)&&(p=parseFloat(RegExp.$1))}else"Netscape"==navigator.appName&&(q=navigator.userAgent,r=/Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/,null!=r.exec(q)&&(p=parseFloat(RegExp.$1)));n=p;var l="createTouch"in f||"ontouchstart"in o,s=l?"touchstart":"click",w=l?"touchstart":"mousedown",u=l?"touchmove":"mousemove",v=l?"touchend":
"mouseup";k.url=hermit.url;k.debugMode=!1;k.preferFlash=5<n?!0:!1;a.init=function(){this.fn.getjson()};a.fn={handleHash:{},bind:f.addEventListener?function(c,b,d){b.addEventListener(c,function(){d.apply(this,arguments);a.fn.handleHash[c]=a.fn.handleHash[c]||[];a.fn.handleHash[c].push(arguments.callee)},!1)}:f.attachEvent?function(c,b,d){b.attachEvent("on"+c,function(){d.apply(this,arguments);a.fn.handleHash[c]=a.fn.handleHash[c]||[];a.fn.handleHash[c].push(arguments.callee)})}:void 0,unbind:f.removeEventListener?
function(c,b){if(a.fn.handleHash[c]){var d=0,e=a.fn.handleHash[c].length;for(d;e>d;d+=1)b.removeEventListener(c,a.fn.handleHash[c][d],!1)}}:f.detachEvent?function(c,b){if(a.fn.handleHash[c]){var d=0,e=a.fn.handleHash[c].length;for(d;e>d;d+=1)b.detachEvent("on"+c,a.fn.handleHash[c][d])}}:void 0,rclass:/[\n\t]/g,rspaces:/\s+/,arraify:function(c){var a=[];try{a=Array.prototype.slice.call(c,0)}catch(d){for(var e,a=[],m=0;e=c[m++];)a.push(e)}return a},hasClass:function(c,b){return 0<=(" "+c.className+
" ").replace(a.fn.rclass," ").indexOf(" "+b+" ")?!0:!1},addClass:function(c,b){if(b&&"string"==typeof b){var d=(b||"").split(a.fn.rspaces);if(c&&1===c.nodeType)if(c.className){for(var e=" "+c.className+" ",m=c.className,f=0,g=d.length;g>f;f++)0>e.indexOf(" "+d[f]+" ")&&(m+=" "+d[f]);c.className=a.fn.trim(m)}else c.className=b}},removeClass:function(c,b){if(b&&"string"==typeof b||void 0===b){var d=(b||"").split(a.fn.rspaces);if(c&&1===c.nodeType&&c.className)if(b){for(var e=(" "+c.className+" ").replace(a.fn.rclass,
" "),f=0,g=d.length;g>f;f++)e=e.replace(" "+d[f]+" "," ");c.className=a.fn.trim(e)}else c.className=""}},getById:function(a){return f.getElementById(a)},getByTagName:function(c,b){return b=b||f,a.fn.arraify(b.getElementsByTagName(c))},getByClassName:function(c,b,d){if(b=b||f,b.getElementsByClassName)return a.fn.arraify(b.getElementsByClassName(c));for(var c=c.replace(/\-/g,"\\-"),e=[],b=a.fn.getByTagName(d||"*",b),d=b.length,c=RegExp("(^|\\s)"+c+"(\\s|$)");d--;)c.test(b[d].className)&&e.push(b[d]);
return e.reverse(),e},each:function(a,b){if(t!=a.length)for(var d=0,e=a.length;e>d&&!1!==b.call(a[d],d,a[d]);d++);else for(name in a)b.call(a[name],name,a[name])},index:function(a,b){var d,e=b.length;for(d=0;e>d;d++)if(a==b[d])return d;return-1},trim:function(a){return a.replace(/^(\s|\u00A0)+/,"").replace(/(\s|\u00A0)+$/,"")},getjson:function(){var c=a.fn.getByClassName("hermit"),b=c.length-1;a.fn.each(c,function(c){var e=this,f=e.getAttribute("songs").split("#:");a.fn.ajaxp({url:"http://goxiami.duapp.com/",
param:{type:f[0],id:f[1]},after:function(f){a.fn.createPlayListUI.call(e,f,c);c==b&&a.fn.autoPlay()}})})},create:function(c){var b=this;i=null!=c?c:0;g=null!=g?g:0;a.sound&&(a.sound.destruct(),g==h[i].length&&(g=0));k.onready(function(){a.sound=k.createSound({id:"goXiami",url:h[i][g].src,volume:80,autoLoad:!1,onload:function(){3>this.readyState&&(a.fn.getByClassName("hermit-detail",b,"div")[0].innerHTML="\u97f3\u4e50\u64ad\u653e\u5668\u521d\u59cb\u5316\u5931\u8d25!")},whileloading:function(){a.fn.getByClassName("hermit-loaded",
b,"div")[0].style.width=100*(this.bytesLoaded/this.bytesTotal)+"%"},whileplaying:function(){var c=a.fn.getByClassName("hermit-duration",b,"div")[0],e=a.fn.getByClassName("hermit-prosess-bar",b,"div")[0],f=100*(this.position/this.duration)+"%",g=a.fn.parseTime(this.position/1E3)+"/"+a.fn.parseTime(this.duration/1E3);!a.moving&&(e.style.width=f);c.innerHTML=g},onplay:function(){var c=a.fn.getByClassName("hermit-song",b,"div"),e=a.fn.getByClassName("hermit-detail",b,"div")[0];a.fn.each(c,function(){a.fn.removeClass(this,
"selected")});a.fn.addClass(c[g],"selected");e.innerHTML=a.fn._expect(c[g].innerHTML,0,40,"...")+"  ("+(g+1)+"/"+h[i].length+")"},onpause:function(){},onfinish:function(){if(g++,a.sound.resume(),g<h[i].length)a.fn.create.call(b,i);else if(parseInt(b.getAttribute("loop"),10))a.fn.getByClassName("hermit-song",b,"div")[0].click();else{var c=a.fn.getByClassName("hermit-prosess-bar",b,"div")[0],e=a.fn.getByClassName("hermit-button",b,"div")[0],f=a.fn.getByClassName("hermit-duration",b,"div")[0],j=a.fn.getByClassName("hermit-song",
b,"div");a.fn.each(j,function(){a.fn.removeClass(this,"selected")});c.style.width=0;i=g=null;a.sound=null;f.innerHTML="";a.fn.removeClass(e,"playing")}}});a.sound.play()})},createPlayListUI:function(c,b){var d=a.fn.getByClassName("hermit-list",this,"div")[0],e="";if(h[b]=[],c.album_id||c.collect_id)c=c.songs,a.fn.each(c,function(){null!=this&&(h[b].push({src:this.song_src}),e+='<div class="hermit-song">'+this.song_title+" - "+this.song_author+"</div>")});else{var f=this.getAttribute("songs").split("#:")[1],
f=f.split(",");a.fn.each(f,function(){null!=c[this]&&(h[b].push({src:c[this].song_src}),e+='<div class="hermit-song">'+c[this].song_title+" - "+c[this].song_author+"</div>")})}d.innerHTML=e;a.fn.playEvent.call(this)},playEvent:function(){var c=this,b=a.fn.getByClassName("hermit-button",c,"div")[0],d=a.fn.getByClassName("hermit-listbutton",c,"div")[0],e=a.fn.getByClassName("hermit-list",c,"div")[0],f=a.fn.getByClassName("hermit-song",e,"div"),j=(parseInt(a.fn._getStyle(f[0],"height"))+1)*f.length,
h=a.fn.getByClassName("hermit-prosess",c,"div")[0],k=a.fn.getByClassName("hermit-prosess-after",h,"div")[0],j=360>=j?j:360,j=j+"px";e.style.height=j;a.fn.each(f,function(){var d=a.fn.index(c,a.fn.getByClassName("hermit"));this.onclick=function(){var e=a.fn.index(this,f);if(i==d)e==g?b.click():(g=e,a.fn.create.call(c,d));else{if(a.sound){var h=a.fn.getByClassName("hermit")[i],j=a.fn.getByClassName("hermit-button",h,"div")[0],h=a.fn.getByClassName("hermit-song",h,"div")[g];a.fn.removeClass(j,"playing");
a.fn.removeClass(h,"selected");a.sound.resume()}g=e;a.fn.addClass(b,"playing");a.fn.create.call(c,d)}}});a.fn.bind(s,b,function(){var d=a.fn.index(c,a.fn.getByClassName("hermit"));if(a.fn.hasClass(b,"playing"))a.fn.removeClass(b,"playing"),a.sound.pause();else if(a.fn.addClass(b,"playing"),a.sound&&i==d)a.sound.play();else{if(a.sound){var e=a.fn.getByClassName("hermit")[i],f=a.fn.getByClassName("hermit-button",e,"div")[0],e=a.fn.getByClassName("hermit-song",e,"div")[g];g=null;a.fn.removeClass(f,"playing");
a.fn.removeClass(e,"selected")}a.fn.create.call(c,d)}});a.fn.bind(s,d,function(){a.fn.hasClass(c,"unexpand")?(a.fn.removeClass(c,"unexpand"),e.style.height=j;if(e.style.display){e.style.display="";}):(a.fn.addClass(c,"unexpand"),e.style.height=0)});a.fn.bind(s,h,function(c){if(a.sound){var b=parseInt(a.fn._getStyle(h,"width")),d=a.fn._offset(h).left,c=a.fn._pageEvent(c).pageX-d,c=c/b*a.sound.duration;a.sound.setPosition(c)}});a.fn.bind(w,k,a.fn._bind(a.fn._start,c))},autoPlay:function(){var c=a.fn.getByClassName("hermit");a.fn.each(c,function(){if(parseInt(this.getAttribute("auto"),
10))return a.fn.getByClassName("hermit-button",this,"div")[0].click(),!1})},_pageEvent:function(a){if(a=a||o.event,l&&a.touches.length)a.pageX=a.touches.item(0).pageX,a.pageY=a.touches.item(0).pageY;else if("undefined"==typeof a.pageX){var b=f.documentElement,d=f.body;a.pageX=a.clientX+(b&&b.scrollLeft||d&&d.scrollLeft||0)-(b&&b.clientLeft||d&&d.clientLeft||0);a.pageY=a.clientY+(b&&b.scrollTop||d&&d.scrollTop||0)-(b&&b.clientTop||d&&d.clientTop||0)}return a},_expect:function(a,b,d,e){return e=a.length>
d-b?e:"",a=a.slice(b,d),a+e},_offset:function(a){var b=a.getBoundingClientRect(),d=a.ownerDocument,a=d.body,d=d.documentElement;return{top:b.top+(self.pageYOffset||d.scrollTop||a.scrollTop)-(d.clientTop||a.clientTop||0),left:b.left+(self.pageXOffset||d.scrollLeft||a.scrollLeft)-(d.clientLeft||a.clientLeft||0)}},_getStyle:function(a,b){return 5<n&&9>n?(b=b.replace(/^(\w)/g,function(a,c){return c.toUpperCase()}),a["client"+b]):f.defaultView.getComputedStyle(a,null).getPropertyValue(b)},_bind:function(a,
b){return function(){return a.apply(b,arguments)}},_start:function(){a.moving=!0;a.fn.bind(u,f,a.fn._bind(a.fn._move,this));a.fn.bind(v,f,a.fn._bind(a.fn._end,this));a.fn.bind("touchcancel",f,a.fn._bind(a.fn._end,this))},_move:function(c){event=a.fn._pageEvent(c);var b=a.fn.getByClassName("hermit-prosess",this,"div")[0],c=a.fn.getByClassName("hermit-prosess-bar",b,"div")[0],d=parseInt(a.fn._getStyle(b,"width")),b=a.fn._offset(b).left,b=event.pageX-b,d=b/d;c.style.width=100*(1<d?1:d)+"%"},_end:function(){a.fn.getByClassName("hermit-prosess-after",
this,"div")[0];if(a.sound){var c=a.fn.getByClassName("hermit-prosess",this,"div")[0],b=a.fn.getByClassName("hermit-prosess-bar",c,"div")[0],c=parseInt(a.fn._getStyle(c,"width")),b=parseInt(a.fn._getStyle(b,"width")),b=b/c,b=(1<b?1:b)*a.sound.duration;a.sound.setPosition(b)}a.fn.unbind(u,f);a.fn.unbind(v,f);a.fn.unbind("touchcancel",f);try{delete a.moving}catch(d){a.moving=t}a.fn.handleHash={}},ajaxp:function(c){setTimeout(function(){var b=(new Date).valueOf(),d=f.createElement("script");body=f.documentElement;
head=body.getElementsByTagName("head")[0];callbackName="hermit"+parseInt(999999*Math.random());c.param.callback=callbackName;c.param._=b;o[callbackName]=function(a){c.after.call(this,a);head.removeChild(d)};d.src=c.url+"?"+a.fn.serialize(c.param);head.appendChild(d)},0)},_loadScript:function(c,b){setTimeout(function(){var d=f.createElement("script");d.src=c;d.readyState?a.fn.bind("readystatechange",d,function(){("loaded"===d.readyState||"complete"===d.readyState)&&(b&&b(),a.fn.unbind("readystatechange",
d))}):a.fn.bind("load",d,function(){b&&b();a.fn.unbind("load",d)});f.getElementsByTagName("head")[0].appendChild(d)},0)},serialize:function(a){var b=[];for(key in a)key=[key,a[key]].join("="),b.push(key);return b.join("&")},parseTime:function(a){if(!isFinite(a)||0>a)return"--:--";var b=Math.floor(a/60),a=Math.floor(a)%60;return(10>b?"0"+b:b)+":"+(10>a?"0"+a:a)}};a.init();window.hermitInit=function(){i=g=null;h=[];a.sound&&a.sound.destruct();a.init()}})(window,document);
